...
class Provider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (_) => CountProvider(), child: FirstProvider());
  }
}

class FirstProvider extends StatefulWidget {
  const FirstProvider({Key? key}) : super(key: key);

  @override
  State<FirstProvider> createState() => _ProviderScreenState();
}

class _ProviderScreenState extends State<FirstProvider> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: Center(
